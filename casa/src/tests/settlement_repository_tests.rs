...
fn settlement_makes_money_unavailable() {
    ...
    let skinner_account = account_service
        .get_latest_statement(accounts.nzd_wallet())
        .unwrap();
...
fn doesnt_settle_already_settle() {
    ...
    let (order3, order4) = quick_order(
        "itchy@springfield.com",
        "scratchy@springfield.com",
        100000,
        200 * 100,
        100000,
        200 * 100,
